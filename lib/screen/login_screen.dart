          ...
          Container(
            ...
            child:
              ...
              Row(
                children: [
                  Padding(
                    padding: EdgeInsets.only(left: 16, top: 32, bottom: 30),
                    child: Text(
                      "Đăng nhập",
                      style: TextStyle(
              ...
              Container(
                ...
                child: TextField(
                  decoration: InputDecoration(
                    ...
                    hintText: 'Nhập số điện thoại của bạn', // Văn bản gợi ý
                  ),
                ),
              ),
              Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: InkWell(
                      child: Text(
                        "Quên mật khẩu?",
                        style: TextStyle(color: Color.fromRGBO(207, 87, 99, 1)),
                      ),
                    ),
                  )
                ],
              ...
              ButtonWidget(
                ...
                content: "ĐĂNG NHẬP",
                contentpadding:
                    EdgeInsets.only(left: 108, top: 14, right: 108, bottom: 14),
                radius: 10,
                padding: EdgeInsets.only(left: 16, right: 16),
              ),
              SizedBox(
              ...
              Padding(
                ...
                child: Text(
                  "Việc bạn tiếp tục sủ dụng trang web này đồng nghĩa bạn đồng ý với điều khoản sử dụng của chúng tôi ",
                  maxLines: 2,
